...
public class DanhMucCanBoServiceImpl implements DanhMucCanBoService {
    ...
    public Flux<DanhMucCanBoDTO> findByCriteria(DanhMucCanBoCriteria criteria, Pageable pageable) {
        LOG.debug("Request to get all DanhMucCanBos by Criteria");
        return danhMucCanBoRepository.findByCriteria(criteria, pageable).map(danhMucCanBoMapper::toDto);
    }
