...
@Component({
  standalone: true,
  selector: 'jhi-chung-thuc',
  templateUrl: './chung-thuc.component.html',
  imports: [
    RouterModule,
    FormsModule,
    SharedModule,
...
export class ChungThucComponent implements OnInit {
  ...
  delete(chungThuc: IChungThuc): void {
    const modalRef = this.modalService.open(ChungThucDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.chungThuc = chungThuc;
