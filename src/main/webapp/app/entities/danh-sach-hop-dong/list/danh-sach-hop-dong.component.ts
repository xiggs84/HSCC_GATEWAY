...
import { DanhSachHopDongService, EntityArrayResponseType } from '../service/danh-sach-hop-dong.service';
...
export class DanhSachHopDongComponent implements OnInit {
  ...
  trackIdHopDong = (_index: number, item: IDanhSachHopDong): string => this.danhSachHopDongService.getDanhSachHopDongIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.danhSachHopDongs = dataFromBody;
  }
