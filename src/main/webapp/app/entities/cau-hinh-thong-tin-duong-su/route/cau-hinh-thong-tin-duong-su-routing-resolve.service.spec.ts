...
describe('CauHinhThongTinDuongSu routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return ICauHinhThongTinDuongSu returned by find', () => {
      // GIVEN
      service.find = jest.fn(idCauHinh => of(new HttpResponse({ body: { idCauHinh } })));
      mockActivatedRouteSnapshot.params = { idCauHinh: 123 };
      ...
      expect(resultCauHinhThongTinDuongSu).toEqual({ idCauHinh: 123 });
    });
