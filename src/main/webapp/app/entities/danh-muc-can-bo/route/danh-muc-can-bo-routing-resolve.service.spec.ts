...
describe('DanhMucCanBo routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IDanhMucCanBo returned by find', () => {
      // GIVEN
      service.find = jest.fn(idCanBo => of(new HttpResponse({ body: { idCanBo } })));
      mockActivatedRouteSnapshot.params = { idCanBo: 123 };
      ...
      expect(resultDanhMucCanBo).toEqual({ idCanBo: 123 });
    });
