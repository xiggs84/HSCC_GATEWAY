...
import { EntityArrayResponseType, DmDuongSuService } from '../service/dm-duong-su.service';
...
export class DmDuongSuComponent implements OnInit {
  ...
  trackId = (_index: number, item: IDmDuongSu): number => this.dmDuongSuService.getDmDuongSuIdentifier(item);
