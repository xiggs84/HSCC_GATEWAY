...
describe('DmDuongSu routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IDmDuongSu returned by find', () => {
      // GIVEN
      service.find = jest.fn(idDuongSu => of(new HttpResponse({ body: { idDuongSu } })));
      mockActivatedRouteSnapshot.params = { idDuongSu: 123 };
      ...
      expect(resultDmDuongSu).toEqual({ idDuongSu: 123 });
    });
