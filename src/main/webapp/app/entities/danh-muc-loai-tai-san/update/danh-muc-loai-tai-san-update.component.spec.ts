...
describe('DanhMucLoaiTaiSan Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should update editForm', () => {
      const danhMucLoaiTaiSan: IDanhMucLoaiTaiSan = { idLoaiTs: 456 };
  ...
  describe('save', () => {
    it('Should call update service on save for existing entity', () => {
      ...
      const danhMucLoaiTaiSan = { idLoaiTs: 123 };
    ...
    it('Should call create service on save for new entity', () => {
      ...
      const saveSubject = new Subject<HttpResponse<IDanhMucLoaiTaiSan>>();
      const danhMucLoaiTaiSan = { idLoaiTs: 123 };
      jest.spyOn(danhMucLoaiTaiSanFormService, 'getDanhMucLoaiTaiSan').mockReturnValue({ idLoaiTs: null });
