...
describe('DanhMucLoaiTaiSan routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IDanhMucLoaiTaiSan returned by find', () => {
      // GIVEN
      service.find = jest.fn(idLoaiTs => of(new HttpResponse({ body: { idLoaiTs } })));
      mockActivatedRouteSnapshot.params = { idLoaiTs: 123 };
      ...
      expect(resultDanhMucLoaiTaiSan).toEqual({ idLoaiTs: 123 });
    });
