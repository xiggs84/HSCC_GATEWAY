...
import { DuongSuTrungCmndService, EntityArrayResponseType } from '../service/duong-su-trung-cmnd.service';
  ...
  ngOnInit(): void {
    this.subscription = combineLatest([this.activatedRoute.queryParamMap, this.activatedRoute.data])
      .pipe(
        ...
        tap(() => {
          if (!this.duongSuTrungCmnds || this.duongSuTrungCmnds.length === 0) {
            this.load();
          }
        }),
      )
