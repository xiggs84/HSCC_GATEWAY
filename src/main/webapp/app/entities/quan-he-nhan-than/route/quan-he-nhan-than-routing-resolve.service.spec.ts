...
describe('QuanHeNhanThan routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IQuanHeNhanThan returned by find', () => {
      // GIVEN
      service.find = jest.fn(idQuanHe => of(new HttpResponse({ body: { idQuanHe } })));
      mockActivatedRouteSnapshot.params = { idQuanHe: 123 };
      ...
      expect(resultQuanHeNhanThan).toEqual({ idQuanHe: 123 });
    });
