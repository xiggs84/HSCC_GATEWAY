...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../phan-loai-hop-dong.test-samples';
  ...
  describe('Service methods', () => {
    ...
    describe('comparePhanLoaiHopDong', () => {
      ...
      it('Should return false if one entity is null', () => {
        const entity1 = { idPhanLoaiHopDong: 'ABC' };
        const entity2 = null;
      ...
      it('Should return false if primaryKey differs', () => {
        const entity1 = { idPhanLoaiHopDong: 'ABC' };
        const entity2 = { idPhanLoaiHopDong: 'CBA' };
      ...
      it('Should return false if primaryKey matches', () => {
        const entity1 = { idPhanLoaiHopDong: 'ABC' };
        const entity2 = { idPhanLoaiHopDong: 'ABC' };
