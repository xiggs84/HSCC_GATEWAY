...
export class PhanLoaiHopDongComponent implements OnInit {
  ...
  trackIdPhanLoaiHopDong = (_index: number, item: IPhanLoaiHopDong): string =>
    this.phanLoaiHopDongService.getPhanLoaiHopDongIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.phanLoaiHopDongs = dataFromBody;
  }
