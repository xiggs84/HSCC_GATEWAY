...
describe('DanhMucDonVi routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IDanhMucDonVi returned by find', () => {
      // GIVEN
      service.find = jest.fn(idDonVi => of(new HttpResponse({ body: { idDonVi } })));
      mockActivatedRouteSnapshot.params = { idDonVi: 123 };
      ...
      expect(resultDanhMucDonVi).toEqual({ idDonVi: 123 });
    });
