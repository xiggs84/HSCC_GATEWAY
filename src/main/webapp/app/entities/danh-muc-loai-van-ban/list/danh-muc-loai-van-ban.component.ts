...
import { DanhMucLoaiVanBanService, EntityArrayResponseType } from '../service/danh-muc-loai-van-ban.service';
...
export class DanhMucLoaiVanBanComponent implements OnInit {
  ...
  trackIdLoaiVb = (_index: number, item: IDanhMucLoaiVanBan): string => this.danhMucLoaiVanBanService.getDanhMucLoaiVanBanIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.danhMucLoaiVanBans = dataFromBody;
  }
